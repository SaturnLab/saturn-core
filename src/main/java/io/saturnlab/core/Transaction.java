package io.saturnlab.core;


import io.saturnlab.crypto.ECKey;
import io.saturnlab.crypto.HashUtil;
import io.saturnlab.util.ByteUtil;
import io.saturnlab.util.RLP;
import io.saturnlab.util.RLPElement;
import io.saturnlab.util.RLPItem;
import io.saturnlab.util.RLPList;
...
import static io.saturnlab.crypto.HashUtil.sha3omit12;
import static io.saturnlab.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static io.saturnlab.util.ByteUtil.ZERO_BYTE_ARRAY;
import static org.apache.commons.lang3.ArrayUtils.isEmpty;


/**
 * A transaction (formally, T) is a single cryptographically
 * signed instruction sent by an actor external to Saturn chain.
...
public class Transaction {
  ...
  /* the amount of token to transfer (calculated as wei) */
  private byte[] value;
  ...
  /* the amount of token to pay as a transaction fee
  ...
  //saturnlab,for test
  public synchronized void setSendAddress(byte[] sendAddress){
